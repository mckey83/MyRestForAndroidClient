...
public class SqlFileParserTest {
    ...
    public void  testReadExistWithourProductStartMarkerFile() {
        ...
        String expected = "SqlFileParser.getItemQueryAll() isContainStartMarker = false isContainEndMarker = true";
    ...
    public void  testFileWithourProductEndMarkerFile() {
        ...
        String expected = "SqlFileParser.getItemQueryAll() isContainStartMarker = true isContainEndMarker = false";
    ...
    public void  testFileIncorrectQuantityOfFieldsMore() {
        ...
        String expected = "SqlFileParser.get() incorrect quantity of fields = 47";
    ...
    public void  testFileIncorrectQuantityOfFieldsLess() {
        ...
        String expected = "SqlFileParser.get() incorrect quantity of fields = 44";
